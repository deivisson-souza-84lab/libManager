...
return [
  ...
  /*
    ...
    | especificação de uma linha de linguagem personalizada específica para uma determinada regra de atributo.
    |
    */
  ...
  /*
    ...
    | por algo mais legível, como "Endereço de E-mail" em vez de "email". Isso simplesmente nos ajuda a
